...
\begin{align}
  ...
  \label{discr-2}
  \sum_{L \in \mathcal{N}_K} \tilde{\mathcal{G}}_{KL} &= Ra Pr T_{K} m_K \vb{e_{z}}\\
  \label{discr-3}
...
(\ref{discr-2}), using the fact that $\sum_{L \in \mathcal N _{K}} m_\sigma \vb{n}_\sigma =
\vb{0}$. On staggered grids however, where velocity variables are
